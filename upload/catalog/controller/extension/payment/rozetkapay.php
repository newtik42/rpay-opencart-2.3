...
class ControllerExtensionPaymentRozetkaPay extends Controller {
    ...
    public function index() {
        ...
        if ($this->session->data['payment_method']['code'] == 'rozetkapay') {
            ...
            return $this->load->view($this->path . ".tpl", $data);
    ...
    public function callback() {
        ...
        $this->extLog(getallheaders());

        $this->extLog('X-ROZETKAPAY-SIGNATURE:' . $this->rpay->getHeaderSignature());
        $this->extLog('SIGNATURE:' . $this->rpay->getSignature(file_get_contents('php://input')));
